    ...
    return (
        <div className="d-flex flex-column flex-shrink-0 p-3 sidebar-container">
            ...
            <ul className="nav nav-pills flex-column mb-auto">
                ...
                <li>
                    <Link to="/starred-tasks" className={`nav-link ${selectedOption === "starred-tasks" ? "active" : ""}`} onClick={() => handleOptionClick("starred-tasks")}>
                    <i className="bi bi-grid-3x3-gap"></i> Starred Tasks
                    </Link>
                </li>
                <li>
                    <Link to="/completed-tasks" className={`nav-link ${selectedOption === "completed" ? "active" : ""}`} onClick={() => handleOptionClick("completed")}>
