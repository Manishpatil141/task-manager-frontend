        ...
        >
            ...
            <div className="row justify-content-center align-items-center" style={{ position: 'absolute', top: '0', left: '0', right: '0', bottom: '0' }}>
                <div className="col-md-7">
                    <div className="card" style={{ backgroundColor: 'rgba(255, 255, 255, 0.8)', padding: '20px' }}>
                        <div className="card-body">
                            {!otpSent ? (
                                <form onSubmit={handleSendOtp}>
                                    ...
                                    {errorMessage && <div className="error-message" style={{ color: 'red', marginBottom: '10px', marginLeft: '40%' }}>{errorMessage}</div>}
